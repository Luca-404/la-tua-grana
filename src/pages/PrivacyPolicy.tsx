function PrivacyPolicy() {
  return (
    <div className="bg-foreground rounded-lg shadow-md max-w-3xl mx-auto my-8 p-8 text-gray-800">
      <h1 className="text-3xl font-bold mb-2 text-center">Privacy Policy</h1>
      <p className="text-sm text-muted mb-6 text-center">Last updated: June 14, 2025</p>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 border-b pb-1">Interpretation and Definitions</h2>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            or &quot;Our&quot; in this Agreement) refers to La tua grana.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to La tua grana, accessible from{" "}
            <a href="https://latuagrana.it" rel="external nofollow noopener" target="_blank">
              https://latuagrana.it
            </a>
          </p>
        </li>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 border-b pb-1">Collecting and Using Your Personal Data</h2>
      <h3 className="text-xl font-semibold mt-6 mb-2">Types of Data Collected</h3>
      <h4 className="text-lg font-semibold mt-4 mb-1">Personal Data</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4 mb-1">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4 mb-1">Business Transactions</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4 mb-1">Law enforcement</h4>
      <p>
      ...
      <h4 className="text-lg font-semibold mt-4 mb-1">Other legal requirements</h4>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 border-b pb-1">Children's Privacy</h2>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 border-b pb-1">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 border-b pb-1">Changes to this Privacy Policy</h2>
      <p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 border-b pb-1">Contact Us</h2>
      <p>If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul>
        <li>By email: latuagrana@gmail.com</li>
      </ul>
    </div>
  )
}
